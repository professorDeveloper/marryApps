...
export const _roles = [
  ...
  `Loyaha koordinatori`,
  `Jamoani boshlovchi`,
  `Programma ishlab chiquvchi`,
  `Marketing strategiyachi`,
  `Ma'lumotlar tahlilchisi`,
  `Mahsulot egasi`,
  `Grafik dizayner`,
  `Operatsion rahbari`,
  `Mijozga yordamni o'rnatuvchi`,
  `Savdo menedzheri`,
  `Kadrlar recruyter`,
  `Biznes maslahatchi`,
  `Moliyaviy planner`,
  `Tarmoq muhandisi`,
  `Kontentning yaratuvchisi`,
  `Sifat kafolati tester`,
  `Ommaviy aloqa ofitseri`,
  `IT administratori`,
  `Hamkorlik ofitseri`,
  `Tadbirlar rejalashtiruvchisi`,
  `Yuridik maslahatchi`,
  `O'qituvchi koordinatori`,
];
...
export const _productNames = [
  `Shahar tadqiqotchisi Krossovkalari`,
  `Klassik charm Loafers`,
  `Tog' sayohat Botkalari`,
  `Elegansiya Stiletto Tukunchiklar`,
  `Quloy Yugurish Ayakkalari`,
  `Chik balet Flat`,
  `Vintaj Oksford Ayakkalari`,
  `Suv o'tkazmaydiganHiking Botkalari`,
  `Kundalik Slip-On Krossovkalari`,
  `Premium Rasm Ayakkalari`,
  `Sportli yo'l yuguruvchilari`,
  `Murakkab Brogues`,
  `Plyaj Sandallari`,
  `Stilish Wedge Tukunchiklar`,
  `Engil o'quv Ayakkalari`,
  `Hashamatli Mokkasinlar`,
  `Durable Ish Botkalari`,
  `Zamonaviy platforma Krossovkalari`,
  `Qulaylik qish Botkalari`,
  `Moda tungi botkalari`,
  `Nafas oladigan Tennis Ayakkalari`,
  `Elegansiya kechasi pompalari`,
  `Zamonaviy Skate Ayakkalari`,
  `Qulaylik yurish Ayakkalari`,
];

// ----------------------------------------------------------------------

export const _tourNames = [
  `Shohona tog'li sarguzashtlar`,
  `Orol cho'pu chodayoni`,
  `Yevropa budana shodosi`,
  `Savannadagi safari ekspeditsiyasi`,
  `Katta kanyon tadqiqotchisi`,
  `Aziyaning tarixiy shaharlari`,
  `Tropik jannat qisqaetishi`,
  `Alaskali yirtga turi`,
  `O'rta dengiz aylanib-yuradigan sayohat`,
  `Sehr Sharq Yevropa`,
  `Ko'zni qamashtiradigan quziqa yo'l sayohati`,
  `Qadimiy xarbalar tadqiqoti`,
  `Avstraliya Outback sarguzashtlari`,
  `Shafali nur tajribasi`,
  `Janub Amerikaning yirtgalar shodosi`,
  `Qiroli qal'alari va saroylar`,
  `Ultimate Plyaj dam olish`,
  `Milli parklar tadqiqoti`,
  `Italiya taomlarining gurmani turi`,
  `Yangi Zelandiya sayoh yo'lollari`,
  `Fransiyaning san'at va tarixi`,
  `Hindiston egzotik yo'llari`,
  `Kanada tog'li yo'lkasi`,
  `Karib saharosi va quvonchi`,
];
...
export const _jobTitles = [
  `Programma muhandisi`,
  `Marketing menedzheri`,
  `Ma'lumotlar olimi`,
  `Grafik dizayner`,
  `Moliyaviy analitik`,
  `Insan resurslari mutaxassisi`,
  `Loyaha menedzheri`,
  `Savdo direktori`,
  `Kontent yozuvchi`,
  `Tarmoq administratori`,
  `Mijozga xizmat ko'rsatuvchi`,
  `Mahsulot menedzheri`,
  `Biznes analitik`,
  `Mexanik muhandisi`,
  `Operatsion menedzheri`,
  `UX/UI dizayner`,
  `Buxgalter`,
  `Ijtimoiy media menedzheri`,
  `Tadqiqot olimi`,
  `Yuridik maslahatchi`,
  `Ommaviy aloqa mutaxassisi`,
  `Sog'liqni saqlash va xavfsizlik ofitseri`,
  `IT qo'llab-quvvatlash mutaxassisi`,
  `Atrof-muhitni muhofaza qiluvchi maslahatchi`,
];
...
export const _taskNames = [
  `Oylik Moliyaviy Hisobotni tayyorlash`,
  `Yangi Marketing Kampaniyasini dizayn qilish`,
  `Mijoz fikri-mulohazasini tahlil qilish`,
  `Veb-sayt mazmunini yangilash`,
  `Bozor tadqiqotini o'tkazish`,
  `Dasturiy ta'minotni ishlab chiqish`,
  `Jamoa yig'ilishini o'tkazish`,
  `Ijtimoiy media postlarini yaratish`,
  `Loyaha rejasini ko'rib chiqish`,
  `Xavfsizlik protokollarini amalga oshirish`,
  `Texnik hujjatlarni yozish`,
  `Yangi mahsulot xususiyatlarini sinab ko'rish`,
  `Mijoz so'rovlarini boshqarish`,
  `Yangi xodimlarni o'qitish`,
  `Logistikani koordinatsiya qilish`,
  `Tarmoq ishlashini kuzatish`,
  `O'quv materiallarini ishlab chiqish`,
  `Matbuot relizini qoralashtirish`,
  `Byudjet taklifi tayyorlash`,
  `Sotuvchi takliflarini baholash`,
  `Ma'lumot tahlilini o'tkazish`,
  `Sifat nazoratini o'tkazish`,
  `Tadbir logistikasini rejalashtirish`,
  `SEO strategiyalarini optimallashtirish`,
];
...
export const _courseNames = [
  ...
  `R bilan ma'lumot fani`,
  `Grafik dizayn asoslari`,
  `Boshlang'ichlar uchun moliyaviy rejalashtirish`,
  `Insan resurslar boshqaruvi asoslari`,
  `Loyaha boshqaruvi asoslari`,
  `Savdo texnikasi va strategiyalari`,
  `Kontentni yozish maestriyasi`,
  `Tarmoq xavfsizligi asoslari`,
  `Mijozga xizmat etish mukammalligi`,
  `Mahsulot boshqaruvi asoslari`,
  `Excel bilan biznes analitikasi`,
  `Mexanika muhandislik prinsiplari`,
  `Liderlik va jamoani boshqarish`,
  `Foydalanuvchi tajribasi (UX) dizayn asoslari`,
  `Buxgalteriya asoslari`,
  `Ijtimoiy media marketing maestriyasi`,
  `Biotexnologiya asoslari`,
  `Yuristlar uchun huquq tadqiqoti`,
  `Ommaviy so'zlashni ishonchi`,
  `Sog'liqni saqlash va farovonlik koching`,
  `Veb-ishlab chiqish bootcamp`,
  `Fotosurat masterklassi`,
];
