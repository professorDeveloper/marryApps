import type { Ingredient, DeductionItem } from '../types';
...
export type DeductionLineItemsApi = {
    getBatchData: () => DeductionItem[];
    restoreFromPersisted: (items: DeductionItem[]) => void;
...
interface DeductionLineItemsProps {
    apiRef: React.RefObject<DeductionLineItemsApi | null>;
...
export const DeductionLineItems = React.memo(function DeductionLineItems({
    apiRef,
    ingredients,
    ingredientsLoading,
