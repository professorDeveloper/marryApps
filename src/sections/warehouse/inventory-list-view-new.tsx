...
import { InventoryDataTable } from './inventory';
                ...
                <Box sx={{ mt: 2 }}>
                    ...
                    <TableContainer>
                        <Table size="small">
                            <TableHead>
                                <TableRow>
                                    <TableCell>{t('inventory.itemName', 'Item Name')}</TableCell>
                                    <TableCell align="right">{t('inventory.quantity', 'Quantity')}</TableCell>
                                    <TableCell align="right">{t('inventory.systemQuantity', 'System Quantity')}</TableCell>
                                    <TableCell align="right">{t('inventory.difference', 'Difference')}</TableCell>
                                </TableRow>
                            </TableHead>
                            <TableBody>
    ...
    return (
        <>
            ...
            <Dialog open={deleteDialogOpen} onClose={handleCancelDelete}>
                ...
                <DialogContent>
                    {t('common.deleteMessage', 'Are you sure you want to delete this inventory?')}
                </DialogContent>
                <DialogActions>
