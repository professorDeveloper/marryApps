                ...
                <Box sx={{ height: 500, width: '100%' }}>
                  <DataGrid
                    ...
                    columns={[
                      ...
                      { field: 'price_per_unit', headerName: t('outgoingInvoices.pricePerUnit', 'Price / Unit'), width: 150 },
                      { field: 'total_amount', headerName: t('outgoingInvoices.total', 'Total'), width: 150 },
                      { field: 'stock_before', headerName: t('outgoingInvoices.stockBefore', 'Stock Before'), width: 120 },
                      { field: 'stock_after', headerName: t('outgoingInvoices.stockAfter', 'Stock After'), width: 120 },
                    ]}
                    autoHeight
