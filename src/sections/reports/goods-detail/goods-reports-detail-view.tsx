  ...
  return (
    <>
      <GenericTableView
        ...
        idField="order_id"
        breadcrumbs={{
          heading: t('overview.reports.goods'),
          links: [
            { name: t('app'), href: paths.menu.root },
            { name: t('overview.reports.title'), href: paths.menu.reports.root },
            { name: t('overview.reports.goods'), href: paths.menu.reports.goods.root },
            { name: t('common.view'), href: '' },
          ],
        }}
      />
