...
const COLORS = {
  primary: "var(--color-primary-500)", // Primary orange from global CSS
  accent: "var(--color-warning-500)",  // Warning orange from global CSS
  core: "var(--color-text-on-primary)" // White text on primary from global CSS
};
