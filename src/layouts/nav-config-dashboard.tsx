    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { title: t('overview.warehouse.invoiceDetails', 'Kirimlar'), path: paths.menu.warehouse.invoiceDetails.root },
          { title: t('overview.warehouse.invoices', 'Invoices'), path: paths.menu.warehouse.invoices.root },
