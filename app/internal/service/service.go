...
type CafeTableI interface {
	...
	UpdateCafeTable(ctx context.Context, tableID string, hallID *string, number *int32, capacity *int32, status *string, posX, posY *float64, width, height, rotation *int32, pricePerHour *int64, tableType *string, shape *string) (*model.CafeTableResponse, error)
...
type InventoryI interface {
	...
	UpsertInventoryItems(ctx context.Context, inventoryID string, req *model.UpsertInventoryItemsRequest) (*model.InventoryResponse, error)
	ReplaceInventoryItems(ctx context.Context, inventoryID string, req *model.UpsertInventoryItemsRequest) (*model.InventoryResponse, error)
...
type OrderI interface {
	...
	GetAllOrders(ctx context.Context, req model.GetOrdersRequest) ([]model.OrderResponse, int64, error)
	GetOrdersByStatus(ctx context.Context, status string, limit, offset int32) ([]model.OrderResponse, int64, error)
	GetOrdersByWaiterID(ctx context.Context, waiterID string, limit, offset int32) ([]model.OrderResponse, int64, error)
	GetOrdersByTableID(ctx context.Context, tableID string) ([]model.OrderResponse, error)
	GetMyOrders(ctx context.Context, waiterID string, req model.GetMyOrdersRequest) ([]model.WaiterOrderListItem, int64, error)
	...
	GetAllOrderItems(ctx context.Context, limit, offset int32) ([]model.OrderItemResponse, int64, error)
	GetOrderItemsByOrderID(ctx context.Context, orderID string, lang string) ([]model.OrderItemWithGoodResponse, error)
	GetOrderItemsByStatus(ctx context.Context, status string, limit, offset int32) ([]model.OrderItemResponse, int64, error)
