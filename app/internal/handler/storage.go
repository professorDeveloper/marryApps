...
func (h *Handler) CreateStorage(c echo.Context) error {
	...
	storage, err := h.service.Storage().CreateStorage(c.Request().Context(), *req.Name, req.BranchID, nameI18nUUID)
	if err != nil {
...
func (h *Handler) UpdateStorage(c echo.Context) error {
	...
	storage, err := h.service.Storage().UpdateStorage(c.Request().Context(), storageID, req.Name, req.BranchID, req.NameI18n)
	if err != nil {
