...
func (h *Handler) CreateCategory(c echo.Context) error {
	...
	category, err := h.service.Category().CreateCategory(c.Request().Context(), req.Name, req.NameI18n, req.DepartmentID, req.StorageID, req.Parent)
	if err != nil {
...
func (h *Handler) UpdateCategory(c echo.Context) error {
	...
	category, err := h.service.Category().UpdateCategory(c.Request().Context(), categoryID, req.Name, req.NameI18n, req.DepartmentID, req.StorageID, req.Parent)
	if err != nil {
